...
Description
-----------
A simple web tool to make life easier when copying from a text document into html. It uses a RegEx to wrap newlines in paragraph tags Ð `<p>newline</p>` and output's those into a `div`. I do plan on adding a copy to clipboard button but it seems it's impossible to do with javascript and the only alternative is **Flash** Ð I hate flash.
